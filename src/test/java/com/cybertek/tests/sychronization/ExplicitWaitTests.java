...
//    }
    ...
    public void waitForVisible(){
      ...
      //  driver.findElement(By.id("username")).sendKeys("tomsmith");
        ...
        //create a webdriver wait objeckt and pass driver and wait duration
        WebDriverWait wait= new WebDriverWait(driver, 10);

        //srart waiting for certain element to be visible
    ...
    public void explicitNotHelpingUsingThreadSleepTest() throws InterruptedException {
        ...
        String tab="//span[@class='title title-level-1']";
       VytrackUtils.selectMenuOption(driver, tab, "");
        WebDriverWait wait= new WebDriverWait(driver, 10);
